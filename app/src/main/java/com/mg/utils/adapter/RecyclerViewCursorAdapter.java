...
/**
 * 支持CursorAdapter的RecyclerViewAdapter
 * CursorFilter.CursorFilterClient 需要将系统的CursorFilter类copy到本地
 * 在build文件中添加：compile 'com.android.support:recyclerview-v7:25.3.1' 支持
 * Created by YJ on 2017/5/14.
 */

public abstract class RecyclerViewCursorAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> implements Filterable, CursorFilter.CursorFilterClient {
    @Override
