...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
    OnVideoViewCallBackLisenter mVideoViewCallBackLisenter;
...
//      return;
        ...
        try {
            ...
            System.out.println("-------------------------------------.............................................................." + Vitamio.getLibraryPath() + "libstlport_shared.so");
    ...
    public void setMediaController(MediaController controller) {
        ...
        if (controller instanceof OnVideoViewCallBackLisenter) {//让使用者继承接口
            mVideoViewCallBackLisenter = (OnVideoViewCallBackLisenter) controller;
        }
        attachMediaController();
    }
    ...
    /**
     *  Must 继承 {@link OnVideoViewCallBackLisenter} mVideoViewCallBackLisenter后，可使用
     * @param scale
     * @param flag
     */

    public void setCenter(float scale, int flag) {
        mVideoViewCallBackLisenter.onCenterMove(scale,flag);
    }
   ...
   public interface OnVideoViewCallBackLisenter {
        /**
         * 滑动屏幕时，修改屏幕中间空间的控制的量，
         * @param scale 修改比例
         * @param flag 修改音量还是亮度
         */
        void onCenterMove(float scale, int flag);
    }
}